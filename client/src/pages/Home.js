        ...
        <div className="mt-4">
          {user.role === 'admin' && (
            <div className="mb-3">
              ...
              <Link to="/manage-volunteers" className="btn btn-outline-secondary mb-2 w-100">👥 Manage Volunteers</Link>
            </div>
          )}

          {user.role === 'volunteer' && (
            <div className="mb-3">
              <Link to="/volunteer-dashboard" className="btn btn-outline-primary mb-2 w-100">📋 Volunteer Dashboard</Link>
